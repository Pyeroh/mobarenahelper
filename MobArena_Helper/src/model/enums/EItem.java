...
public enum EItem {
	...
	custom(-1, 0, "custom", null),
	money(-2, 0, "money", null),

	// Blocks
	stone(1, 0, "STONE", EItemCat.block),
	/*
	 * 1.8 granite(1,1,"STONE",EItemCat.block), granite_polished(1,2,"STONE",EItemCat.block),
	 * diorite(1,3,"STONE",EItemCat.block), diorite_polished(1,4,"STONE",EItemCat.block),
	 * andesite(1,5,"STONE",EItemCat.block), andesite_polished(1,6,"STONE",EItemCat.block),
	 */
	...
	private EItem(int id, int meta, String realname, EItemCat category) {
		...
		StringBuffer imagepath = new StringBuffer("gui/eitems/" + dossier + "/" + (id > 0 ? id + "_" : realname));
	 ...
	 * @deprecated ne faisait le formatage que pour un nom anglais, inutile depuis la localisation du logiciel, mais
	 *             conservé pour la technique
	 */
	@Deprecated
	 ...
	 *
	 * @param name
	 *            la chaine de comparaison, peut être renvoyée par {@link EItem#getGuiName()}
