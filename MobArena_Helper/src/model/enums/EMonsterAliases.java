...
public enum EMonsterAliases {
	...
	enderdragon(EMonsters.enderdragon),
	enderdragons(EMonsters.enderdragon, true),
	...
	baby_zombie_villager(EMonsters.baby_zombie_villager),
	baby_zombie_villagers(EMonsters.baby_zombie_villager, true),
	...
	horse(EMonsters.horse),
	horses(EMonsters.horse, true),
	donkey(EMonsters.donkey),
	donkeys(EMonsters.donkey, true),
	mule(EMonsters.mule),
	mules(EMonsters.mule, true),
	skeleton_horse(EMonsters.skeleton_horse),
	skeleton_horses(EMonsters.skeleton_horse, true),
	undead_horse(EMonsters.undead_horse),
	undead_horses(EMonsters.undead_horse, true),
